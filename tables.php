...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // "Update" buttons ke liye event delegation
  document.body.addEventListener('click', function (event) {
    if (event.target.classList.contains('update-btn')) {
      ...
      var productDescription = "Yahan aap description ko retrieve karne ka tareeqa implement karein"; // Description ko retrieve karne ka tareeqa implement karein
  ...
  // Modal ko close karein jab user modal ke bahar click kare
